...
; Saratoga photo: https://azurlane.koumakan.jp/Saratoga/Gallery#Virtual_Idol

; FileInstall won't work if the folder doesn't exist already
if !FileExist("%A_Temp%\AzurLaneAutoHelper")
    FileCreateDir, %Assets%

if !FileExist("%A_Temp%\AzurLaneAutoHelper\saratoga.png")
    FileInstall, Assets\saratoga.png, %Assets%\saratoga.png, 1
